...
void RainbowQuad(){
    ...
    if (Mode == 1) {
      ...
      MaxBrightReductionQuad1 = constrain(20, 0, MaxBright);
      MaxBrightReductionQuad2 = constrain(60, 0, MaxBright);
      MaxBrightReductionQuad3 = constrain(110, 0, MaxBright);
      MaxBrightReductionQuad4 = constrain(170, 0, MaxBright);
    }
    else if (Mode == 2) {
      randomOnce = 0;
      setRandomBrightsOnce();
      
      MaxBrightReductionQuad1 = constrain(randomBright01, 0, MaxBright);
      MaxBrightReductionQuad2 = constrain(randomBright02, 0, MaxBright);
      MaxBrightReductionQuad3 = constrain(randomBright03, 0, MaxBright);
      MaxBrightReductionQuad4 = constrain(randomBright04, 0, MaxBright);
    }
    else if (Mode == 3) {
