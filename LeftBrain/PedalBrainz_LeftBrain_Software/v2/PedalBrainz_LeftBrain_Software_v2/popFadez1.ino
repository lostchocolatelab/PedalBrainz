/* pop_fade_demo https://codebender.cc/sketch:386117#FastLED_pop_fade.ino
By: Andrew Tuline
Date: Sep, 2014
...
//#define PINSTRIP 4                                             // Data pin to connect to the strip.
//#define LED_CK 11
...
//uint8_t maxBrightness = 128;                                     // Overall brightness definition. It can be changed on the fly.
...
//  LEDS.addLeds<LED_TYPE, PINSTRIP, COLOR_ORDER>(leds, NUM_LEDS);          // Use this for WS2812B
//  LEDS.addLeds<LED_TYPE, PINSTRIP, LED_CK, COLOR_ORDER>(leds, NUM_LEDS);  // Use this for WS2801 or APA102
  LEDS.addLeds<WS2812,PINSTRIP,RGB>(leds,NUM_LEDS);
