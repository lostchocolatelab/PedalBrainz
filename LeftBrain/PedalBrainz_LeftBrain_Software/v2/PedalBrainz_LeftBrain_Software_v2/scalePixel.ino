...
void scalePixelInnerRed (int val){
      ...
      x = multiMap(controlAmount, in, out, 80);
      // This maps the values for the Modez.
      innerValueRed = mapfloat(x, 0, 190, 0, 190);
      //innerValue = constrain(x, 0.0, 140.0);
...
void scalePixelInnerBlue (int val){
      ...
      x = multiMap(controlAmount, in, out, 80);
      // This maps the values for the Modez.
      innerValueBlue = mapfloat(x, 0, 190, 0, 190);
      //innerValue = constrain(x, 0.0, 140.0);
...
void scalePixelInnerGreen (int val){
      ...
      x = multiMap(controlAmount, in, out, 80);
      // This maps the values for the Modez.
      innerValueGreen = mapfloat(x, 0, 190, 0, 190);
      //innerValue = constrain(x, 0.0, 140.0);
