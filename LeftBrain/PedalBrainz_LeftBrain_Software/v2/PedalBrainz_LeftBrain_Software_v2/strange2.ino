...
void attractorzPixel()
{
  if (Mode == 1)
  {
      ...
      pixel.setPixelColor(0, (scaledInnerCombined), (0), (0));   //Single Output Scaled XYZ
      inner.setPixelColor(0, (scaledInnerCombined), (0), (0));   //Single Output Scaled XYZ
  ...
  else if (Mode == 2)
  {
      ...
      for (int p = 0; p < strip.numPixels(); p++) {   // For each pixel in strip...
        strip.setPixelColor(p, colorBlueTurquoise);
  ...
  else if (Mode == 3)
  {
    ...
    //   }
      ...
      for (int p = 0; p < strip.numPixels(); p++) {   // For each pixel in strip...
        strip.setPixelColor(p, colorGreenMint);
  ...
  else if (Mode == 4)
  {
      ...
      for (int p = 0; p < strip.numPixels(); p++) {   // For each pixel in strip...
        strip.setPixelColor(p, colorGreenPea);
  ...
  else if (Mode == 9)
  {
      ...
      for (int p = 0; p < strip.numPixels(); p++) {   // For each pixel in strip...
        strip.setPixelColor(p, colorRedPurple);
  ...
  else if (Mode == 10)
  {
      ...
      for (int p = 0; p < strip.numPixels(); p++) {   // For each pixel in strip...
          strip.setPixelColor(p, colorRedLight);
