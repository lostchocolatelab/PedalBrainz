...
void flashLED(int ledPinNum) {
  ...
  if (ledPinNum == 0){
    strip.setPixelColor(0, 255, 107, 0); // Yellow LED pin
    strip.setBrightness(255);
    strip.show();
    inner.setPixelColor(0, 255, 107, 0);
    pixel.setPixelColor(0, 255, 107, 0);
    inner.show();
    pixel.show();
    digitalWrite(buttonPinUp, HIGH);
    Serial.println("FLASHING - " + String(ledPinNum));
  }
  else if (ledPinNum == 1){
    ...
    strip.setPixelColor(2, 10, 200, 10); // Red LED pin
    strip.setBrightness(255);
    strip.show();
    inner.setPixelColor(0, 10, 200, 10);
    pixel.setPixelColor(0, 10, 200, 10);
    inner.show();
    pixel.show();
    digitalWrite(buttonPinDown, HIGH);
    delay(500);
